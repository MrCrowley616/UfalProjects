    ...
    $.fn.richText = function( options ) {
        ...
        var settings = $.extend({
            ...
            translations: {
                ...
                'orange': 'Laranja',
                'yellow': 'Amarelo',
                'imageURL': 'Imagem em URL',
                'fileURL': 'Arquivo em URL',
                'linkText': 'Texto link',
                'url': 'URL',
                'size': 'Tamanho',
                ...
                'columns': 'Colunas',
                'add': 'Add',
                'pleaseEnterURL': 'Adiciona a URL',
                'videoURLnotSupported': 'Vídeo URL não é suportado',
                'pleaseSelectImage': 'Selecione a imagem',
                'pleaseSelectFile': 'Selecione o arquivo',
                'bold': 'Negrito',
                'italic': 'Italic',
                'underline': 'Sublinhado',
                'alignLeft': 'Alinhado a Esquerda',
                'alignCenter': 'Alinhar ao Centro',
                'alignRight': 'Alinhar a Direita',
                'addOrderedList': 'Add lista ordenada',
                'addUnorderedList': 'Add lista desordenada',
                'addHeading': 'Add Titulo',
                'addFont': 'Add fonte',
                'addFontColor': 'Add Cor da Fonte',
                'addFontSize' : 'Add Tamanho da Fonte',
                'addImage': 'Add imagem',
                'addVideo': 'Add vídeo',
                'addFile': 'Add Arquivo',
                'addURL': 'Add URL',
